...
class AerobicTypes : ObservableObject {
    ...
    var exercise1 = ExerciseInfo(name: "RunningUphill", imageName: "RunUpHill", description:"1. Find an approximately 10 degree or higher inclined hill.                                                                2. Run uphill continuously for 12 mins covering about 100 meters                                                            3. Take a rest of 45 seconds", time: 55, timeMin: 12)
    var exercise2 = ExerciseInfo(name: "JumpingRopes", imageName: "JumpingRopes",  description:"1. Find a Jumping rope.                                             2. Jump continuously for 2 minutes at the same speed.                                                                            3. Rest for 1 minute                                                    4. Repeat the process with increasing the speed each round.", time: 150, timeMin: 15)
    var exercise3 = ExerciseInfo(name: "Cycling",  imageName: "Cycle", description:"1. Cycle at an average speed on a flat road with minimal turns.", time: 10, timeMin: 40)
    var exercise4 = ExerciseInfo(name: "Running",  imageName: "aerobic4", description:"1. Run 400m at the same speed                                        2. Rest for 1 minute                                                       3. Repeat 12 times", time: 80, timeMin: 12)
